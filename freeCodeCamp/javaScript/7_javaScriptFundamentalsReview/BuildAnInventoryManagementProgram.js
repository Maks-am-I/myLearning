...
// 1. Объявляем пустой массив inventory
const inventory = [];

// 2. Функция findProductIndex - поиск индекса продукта по имени
